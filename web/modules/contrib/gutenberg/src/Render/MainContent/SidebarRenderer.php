...
namespace Drupal\gutenberg\Render\MainContent;
...
use Drupal\gutenberg\Ajax\OpenInSidebarCommand;
 ...
 * @internal
 */
class SidebarRenderer extends DialogRenderer {
  ...
  public function renderResponse(array $main_content, Request $request, RouteMatchInterface $route_match) {
    ...
    $main_content['#attached']['library'][] = 'gutenberg/drupal.dialog.sidebar';
    ...
    $response->addCommand(new OpenInSidebarCommand($title, $content, $options, NULL, $this->position));
    return $response;
  }
